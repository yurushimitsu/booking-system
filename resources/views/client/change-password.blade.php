...
@section('title', 'Booking | Change Password')
...
<body style="background: linear-gradient(to right, #F9F8FF, #B3D6FD);">
    <div class="flex items-center justify-center mt-20 p-7">
        <div class="bg-white w-xl p-10 rounded-3xl shadow-lg">
            <form id="changePasswordForm" action="{{ route('changePassword') }}" method="POST">
                ...
                <div class="relative z-0 w-full mb-9 group">
                    ...
                    <button type="button" tabindex="-1" class="absolute right-0 top-1/2 transform -translate-y-1/2 text-sm text-gray-500 px-2 focus:outline-none" onclick="togglePasswordVisibility('old-password', this)" >
                ...
                <div class="relative z-0 w-full mb-9 group">
                    ...
                    <button type="button" tabindex="-1" class="absolute right-0 top-1/2 transform -translate-y-1/2 text-sm text-gray-500 px-2 focus:outline-none" onclick="togglePasswordVisibility('new-password', this)" >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        </svg>
                ...
                <div class="flex justify-end gap-2">
                    <a href="{{ route('myBookings') }}" class="text-blue-700 bg-transparent hover:bg-gray-200 border border-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-25 py-2.5 text-center">Cancel</a>
