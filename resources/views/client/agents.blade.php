            ...
            <div class="flex flex-wrap justify-center pt-10" id="agentsList">
                ...
                <div class="p-10 relative">
                    <div class="min-w-40 max-w-50 bg-transparent rounded-lg ">
                        ...
                        <a href="/appointment/form?agent={{ $row->account_no }}" class="inline-flex w-full text-center justify-center py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-blue-500 to-blue-900 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Book
                        </a>
                    </div>
                </div>
                                ...
                                $('#agentsList').append(`
                                    <div class="p-10 relative">
                                        <div class="min-w-40 max-w-50 bg-transparent rounded-lg ">
                                            ...
                                            <a href="/appointment/form?agent=${agent.account_no}" class="inline-flex w-full text-center justify-center py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-blue-500 to-blue-900 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                                Book
                                            </a>
                                        </div>
                                    </div>
