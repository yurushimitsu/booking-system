                    ...
                    <form class="p-3" id="bookAppointment" action="{{ route('postAppointmentRequest') }}" method="POST">
                        ...
                        <div id="form-section-1">
                            ...
                            <div class="relative z-0 w-full mb-9 group">
                                <input type="text" name="fullname" id="fullname" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ session('user_role') === 'client' ? $client->client_name : '' }}" required />
                            ...
                            <div class="relative z-0 w-full mb-9 group">
                                <input type="text" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ session('user_role') === 'client' ? $client->client_email : '' }}" required />
                            ...
                            <div class="relative z-0 w-full mb-9 group">
                                <input type="text" name="contact" id="contact" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ session('user_role') === 'client' ? $client->client_contact : '' }}" required />
                            ...
                            <div class="flex justify-end gap-2 absolute bottom-10 right-10">
                                ...
                                {{-- <a href="http://intern-project.lk2jxa6hq2-95m32kpgd3rv.p.temp-site.link/booking-page/" class="text-blue-700 bg-transparent hover:bg-gray-200 border border-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-25 py-2.5 text-center">Cancel</a> --}}
